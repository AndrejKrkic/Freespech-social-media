...
export default function Post({post}){
    ...
    const postaviCommentHandler = async () => {
        try {
        ...
        <div className="post">
            ...
            <Popup trigger=
                ...
                <div className="postBottom">
                    ...
                    <Popup trigger=
                {<span className="commentPostCounter">{post.comments} komentari</span>}
                position="right center">
                <div>Postavi komentar</div>
                <input type="text" ref={description}/>
                <button onClick={postaviCommentHandler}>Postavi</button>
            </Popup>
